...
Our tools are only as good as their documentation. You'll write and maintain READMEs, API references, tutorials, and blog posts across all Spikenard projects. The goal isn't comprehensive documentation — it's useful documentation. Every page should answer a question someone actually has.

## What you'll do

- Write and maintain documentation for [flags.zig](https://github.com/spikenardco/flags.zig), [monimejs](https://github.com/spikenardco/monimejs), [tip](https://github.com/spikenardco/tip), and new projects
